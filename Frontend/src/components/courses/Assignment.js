                ...
                <div className='flex w-11/12'>
                    ...
                    <div className='flex flex-col w-3/4 ml-48'>
                        ...
                        <div key={assignment._id} className='mt-4'>
                            ...
                            <div className='flex flex-col mt-4'>
                                ...
                                <p className='font-sans text-start ml-14 text-base text-gray-500 font-normal mt-1'>Dr. Usman</p>
                            ...
                            <div className='flex flex-row justify-center' key={assignment._id}>
                                <div className='flex border items-center mt-8 w-11/12 h-20 rounded-lg justify-between p-6'>
                                    <div className=''>
                                        <div className='flex flex-row gap-4'>
                    ...
                    <div className='flex flex-col border h-40 w-1/4 rounded-lg shadow-md'>
                        ...
                        <div className='flex flex-col gap-2 items-center justify-center'>
                            ...
                            {assignmentStatus === "Not Submitted" && (
                                <button className='border rounded-md bg-[#00A86B] text-white p-2 w-3/4' onClick={() => handleUpload(assignment._id)}>
                                    Submit
                                </button>
                            )}
                        </div>
